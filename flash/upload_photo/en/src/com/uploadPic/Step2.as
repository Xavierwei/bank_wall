package com.uploadPic 
{
	...
	public class Step2 extends MovieClip 
	{
		...
		private var _dStr:String="Enter your description here with the corresponding #hashtags (Ex: It was a very productive #meting at #SG)"
		private var _w = 175;
		...
		private var _exifObject:IExifReader;
		
		public function Step2() 
		{
			_exifObject = new ExifReader();
			...
			_exifObject.readData(_appModel.picData);
			//trace(_exifObject.getTagByName("Orientation").value)
		}
		private function loadCompleteHandler(e:Event):void {
			picMC.mc.addChild(_loader);
			if(_exifObject.getTagByName("Orientation")&&_exifObject.getTagByName("Orientation").value){
			switch(_exifObject.getTagByName("Orientation").value){
				case 3:
					_loader.rotation+=180;
					_loader.x=_loader.width;
		...
		private function publishClickHandler(e:MouseEvent):void {
			...
			if (description.text == _dStr) {
				...
				tipMC_0.visible = true;
				tipMC_0.t.text = "The hashtag can't include illegal characters";
				b=false;
			}
